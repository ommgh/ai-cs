  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        <section className="bg-linear-to-b to-muted from-background min-h-screen">
              ...
              <div className="md:w-1/2">
                <div>
                  ...
                  <p className="text-muted-foreground my-8 max-w-2xl text-balance text-xl">
                    One tool that does it all. Answer, generate, analyze, and
                    chat—right inside one Service.
                  </p>

                  <div className="flex items-center gap-3">
                    <Button asChild size="lg" className="pr-4.5">
                      <Link href="/chat">
                        <span className="text-nowrap">Start Chat</span>
